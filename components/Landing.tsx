      ...
      <div className="space-y-8">
        <h1 className="space-y-3 text-5xl font-black tracking-wide lg:text-7xl xl:text-8xl">
          ...
          <span className="block text-white">
            <Typewriter
                options={{
                  strings: ['ICONIC ARTISTRY', 'SPIRITUAL CANVASES', 'SACRED ARTISTRY','PORTRAIT', 'LANDSCAPE' ],
                  autoStart: true,
                  loop: true,
                }}
              />
  ...
  >
    Projects
      ...
      <div  data-aos="fade-down" className="relative">
        <img
          src="/project.jpg" // Replace with the image URL for your project
          alt="Project 1"
          className="w-full h-auto object-cover rounded-md"
        />
      ...
      <div  data-aos="fade-up" className="relative">
        <img
          src="/project2.jpg" // Replace with the image URL for your project
          alt="Project 2"
          className="w-full h-auto object-cover rounded-md"
        />
        <div  className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
